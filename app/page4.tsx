...
export default function Home() {
  ...
  background:
    ...
    radial-gradient(900px 500px at 10% 10%, rgba(10,143,188,.07), transparent 55%),
    var(--bg);
  color:var(--text);
  min-height:100vh;
}
  ...
  display:grid;place-items:center;box-shadow:var(--shadow2);overflow:hidden;flex-shrink:0
}
...
.mobileMenu .primaryBtn{
  ...
  font-size:13px;
  color:#fff;
  background:linear-gradient(180deg,#0A8FBC,#006C8E);
  box-shadow:0 6px 14px rgba(0,108,142,.18);
  border:none;
  cursor:pointer;
